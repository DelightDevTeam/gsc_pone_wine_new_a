...
class SpecialCard extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:special-card';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/special_card_game_list.json');
        $outputFilePath = base_path('app/Console/Commands/data/SpecialCardModify.json');
