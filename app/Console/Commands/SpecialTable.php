...
class SpecialTable extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:special-table';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/special_game_table_list.json');
        $outputFilePath = base_path('app/Console/Commands/data/SpecialTableModify.json');
