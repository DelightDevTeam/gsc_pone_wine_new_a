        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-end mb-3">
                    <a href="{{ route('admin.senior.create') }}" class="btn btn-success " style="width: 100px;"><i
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>{{ number_format($user->balanceFloat) }}</td>
                                        ...
                                        {{-- // $poneWintAmt = $user->children->flatMap->children->flatMap->children->flatMap->poneWinePlayer->sum('win_lose_amt');
                                    ...
                                    <td>
                                        ...
                                        <form class="d-none" id="banUser-{{ $user->id }}"
                                            action="{{ route('admin.senior.ban', $user->id) }}"
                                            method="post">
                                            @csrf
                                            @method('PUT')
                                        </form>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.senior.report', $user->id) }}"
                                            data-bs-toggle="tooltip" data-bs-original-title="Reports"
                                            class="btn btn-info btn-sm">
                                            <i class="fa-solid fa-money-bill-transfer"></i>
                                            Reports
