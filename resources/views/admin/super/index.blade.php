        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Super List</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-end mb-3">
                    <a href="{{ route('admin.super.create') }}" class="btn btn-success " style="width: 100px;"><i
                        ...
                        <table id="mytable" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php
                                        $poneWintAmt = $user->children->flatMap->children->flatMap->children->flatMap->children->flatMap->poneWinePlayer->sum('win_lose_amt');
                                    ...
                                    <td>
                                        ...
                                        <form class="d-none" id="banUser-{{ $user->id }}"
                                            action="{{ route('admin.super.ban', $user->id) }}"
                                            method="post">
                                            @csrf
                                            @method('PUT')
                                        </form>
